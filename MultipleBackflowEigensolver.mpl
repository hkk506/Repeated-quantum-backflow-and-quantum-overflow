...
if not(assigned(times)) then times:="-0.901,-0.346,-0.099,0.099,0.346,0.901"; fi;
...
MatrixElement_string:=cat("auxvals/arb/MB_N0_",N,"MAX",N,"_t",times,"_delta",delta,"_a",tA,"_DPS",dps,".mpl");
#MatrixElement_string:=cat("auxvals/MB_MAPLE_N0","_",Nstop,"MAX",N,"_M",M,"_delta",tdelta,"_a",tA,"_DPS",dps,".mpl");
#MatrixElement_string:=cat("auxvals/arb/MB_N0_",N,"MAX",N,"_M",M,"_delta",tdelta,"_a",tA,"_DPS",dps,".mpl");
#MatrixElement_string2:=cat("auxvals/MB_N0_",200,"MAX",N,"_M",M,"_delta",tdelta,"_a",tA,"_DPS",dps,".mpl");
#MatrixElement_string2:=cat("auxvals/MB_N0_",N,"MAX",N,"_M",M,"_delta",tdelta,"_aOpt_DPS",dps,".mpl");
...
#for jj from 1 to 100 do:
#lambda:=min(SingularValues(P[1..jj,1..jj])):
#printf("Smallest singular value for dimension %d is: %.30E\n",jj, lambda):
#od:
Digits;
maxests, max2ests, minests, min2ests:=gen_eigs(B, P):
cat("maxests/maxestsN",Nstart,"_",Nstop,"MAX",N,"M",M,"d",tdelta,"a",tA,".m");s
;
2*maxests[-1]+1;
...
save max2ests, cat("maxests/max2estsN",Nstart,"_",Nstop,"MAX",N,"M","t",times,"d",tdelta,M,"A",A,".m");
save min2ests, cat("maxests/min2estsN",Nstart,"_",Nstop,"MAX",N,"M","t",times,"d",tdelta,M,"A",A,".m");
listplot(maxests);
maxests[-1];
listplot(minests);
minests[-1];
...
min2ests[-1];
listplot(max2ests);
read "maxests/maxestsN1_50MAX100M2t-0.809,-0.191,0.191,0.809d0.0A1.m":
maxests[-1];
