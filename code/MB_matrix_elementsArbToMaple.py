...
The parameters sent via command line should have the structure:
    N_start N_stop N_max times delta A (e.g. 0 10 10 -3,-1,1,3 -0.25 1.0)
    OR 
    N_start N_stop N_max M delta A (e.g. 0 10 10 2 -0.25 1.0)
"""
...
if mode == 0:
    print(str_times)
    out_file = ('auxvals/MB_N'+str(N_start)+'_'+str(N_stop)+'MAX'+str(N_max)
